...
extern void *mono_aot_module_IOSparking_info;
...
extern void *mono_aot_module_clipclapcharge_info;
...
{
	mono_aot_register_module (mono_aot_module_IOSparking_info);
	...
	mono_aot_register_module (mono_aot_module_clipclapcharge_info);
...
void xamarin_setup ()
{
	...
	xamarin_executable_name = "IOSparking.exe";
